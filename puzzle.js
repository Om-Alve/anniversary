...
// normal image is re-drawn
  ...
  congratsMessage.style.zIndex = '100';
  congratsMessage.style.transform = 'translate(-50%, -50%)';
  congratsMessage.style.padding = '20px';
  congratsMessage.style.backgroundColor = 'rgba(0, 128, 0, 0.8)'; // Green background with opacity
  congratsMessage.style.borderRadius = '10px'; // Rounded corners
  congratsMessage.style.boxShadow = '0 0 10px rgba(0, 0, 0, 0.5)'; 
  this.divGame.appendChild(congratsMessage);
  this.canvMobile.style.zIndex = '99';
